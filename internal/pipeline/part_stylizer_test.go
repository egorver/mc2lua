...
func TestPartStylizer_MapFace(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "front is north", face: model.FaceFront, want: model.FaceIndexFront},
		{name: "back is south", face: model.FaceBack, want: model.FaceIndexBack},
		...
		{name: "rotY 90 left to north", face: model.FaceLeft, rotY: 90, want: model.FaceIndexFront},
		{name: "rotY 90 right to south", face: model.FaceRight, rotY: 90, want: model.FaceIndexBack},
		{name: "rotY 180 front to south", face: model.FaceFront, rotY: 180, want: model.FaceIndexBack},
