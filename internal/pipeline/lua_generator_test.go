...
func TestWriteSimplePart(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			style: makeStyledBlock("minecraft:stone", "", true,
...
func TestWriteComplexParts(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			style: makeStyledBlock("minecraft:stone", "", false,
		...
		},
		{
			...
			style: makeStyledBlock("minecraft:oak_stairs", "half=bottom,facing=north", false,
...
func TestRun(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			styleIdx: func() *index.StyleIndex {
				...
				idx.Add("minecraft:stone", "", makeStyledBlock("minecraft:stone", "", true,
					makeStyledElement(0, 0, 0, 16, 16, 16, model.Color{128, 128, 128}, "Slate"),
				))
				return idx
			}(),
		...
		},
		{
			...
			styleIdx: func() *index.StyleIndex {
				idx := index.NewStyleIndex()
				idx.Add("minecraft:oak_stairs", "facing=north,half=bottom", makeStyledBlock("minecraft:oak_stairs", "facing=north,half=bottom", false,
					makeStyledElement(0, 0, 0, 16, 8, 16, model.Color{131, 84, 50}, "Wood"),
					makeStyledElement(0, 8, 0, 16, 16, 8, model.Color{131, 84, 50}, "Wood"),
				))
				return idx
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			count, err := svc.Run(tt.blocks, tt.cuboids, *tt.styleIdx, tt.scale, outPath)
			require.NoError(t, err)
			require.Equal(t, tt.wantCount, count)
...
func TestRun_WriteError(t *testing.T) {
	...
	_, err := svc.Run(nil, nil, *index.NewStyleIndex(), 4, outPath)
	require.Error(t, err)
