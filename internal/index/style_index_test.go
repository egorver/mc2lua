...
func TestStyleIndexAddAndGet(t *testing.T) {
	...
	idx.Add("minecraft:oak_fence", "water=true", model.StyledBlock{IsFullBlock: false})
	...
	tests := []struct {
		...
		{name: "existing key with props", id: "minecraft:oak_fence", props: "water=true", want: model.StyledBlock{IsFullBlock: false}, wantOk: true},
